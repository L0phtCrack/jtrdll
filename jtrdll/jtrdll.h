...
JTRDLL_IMPEXP void jtrdll_preflight(struct JTRDLL_PREFLIGHT *jtrdllpreflight);
#endif
...
typedef void (TYPEOF_jtrdll_preflight)(struct JTRDLL_PREFLIGHT *jtrdllpreflight);
